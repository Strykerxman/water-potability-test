...
def load_params(filepath: str) -> float:
    try:
        ...
        raise Exception(f"Error loading paramaters from {filepath}: {e}")
...
def split_data(data: pd.DataFrame, test_size: float ) -> tuple[pd.DataFrame]:
    try:
...
def main():
    ...
    data_filepath = r"C:\Users\Martin\Desktop\MLOpsProj\data\water_potability.csv"
